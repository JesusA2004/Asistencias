...
import { AlertTriangle, Camera, ShieldAlert, UserCheck } from '@lucide/vue';
    ...
    <form class="space-y-6" @submit.prevent="$emit('submit')">
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
            <Card>
                <CardHeader>
                    <CardTitle class="flex items-center gap-2 text-base">
                        <UserCheck class="h-4 w-4 text-muted-foreground" /> Asistencia de colaboradores
                    </CardTitle>
                </CardHeader>
            ...
            <Card>
                <CardHeader>
                    <CardTitle class="flex items-center gap-2 text-base">
                        <Camera class="h-4 w-4 text-muted-foreground" /> Captura por supervisor
                    </CardTitle>
                </CardHeader>
                <CardContent class="space-y-2">
                    <p class="px-1 pb-1 text-xs text-muted-foreground">
            ...
            <Card>
                <CardHeader>
                    <CardTitle class="flex items-center gap-2 text-base">
                        <ShieldAlert class="h-4 w-4 text-muted-foreground" /> Evidencia y revisión
                    </CardTitle>
                </CardHeader>
            ...
            <Card>
                <CardHeader>
                    <CardTitle class="flex items-center gap-2 text-base">
                        <AlertTriangle class="h-4 w-4 text-muted-foreground" /> Aviso legal
                    </CardTitle>
                </CardHeader>
                <CardContent class="space-y-3">
                    <FormField
